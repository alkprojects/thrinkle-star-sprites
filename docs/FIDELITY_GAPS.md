...
0b. **Backgrounds should be continuously scrolling terrain** (measured 2026-06-11 from 60fps longplay footage, frame-differencing over 600 frames: ~1 native px/frame with periodic holds, mean 0.8). The original flies over lush top-down landscapes (forest, coastline, castles); the constant downward terrain flow is a large part of its sense of speed. Current: static sky gradients. Needs tiling terrain art + a scroll layer at ~0.8 u/tick.
